...
parser.add_argument('-n', '--nether', type=bool, default=False, help='Whether to convert from nether coords or overworld coords.')
...
print(f'From X:{args.x}, Y:{args.y}, Z:{args.z} to X:{conversion[0]}, Y:{conversion[1]}, Z:{conversion[2]}.')